...
try:
    data = pandas.read_csv("/Users/anamika/Documents/100_Days_of_Python/100-Days-Of-Python/Day 31/data/words_to_learn.csv")
except FileNotFoundError:
    original_data = pandas.read_csv("/Users/anamika/Documents/100_Days_of_Python/100-Days-Of-Python/Day 31/data/french_words.csv")
    print(original_data)
...
def is_known():
    ...
    data.to_csv("/Users/anamika/Documents/100_Days_of_Python/100-Days-Of-Python/Day 31/data/words_to_learn.csv", index=False)
    next_card()
...
card_back_img = PhotoImage(file="/Users/anamika/Documents/100_Days_of_Python/100-Days-Of-Python/Day 31/images/card_back.png")
